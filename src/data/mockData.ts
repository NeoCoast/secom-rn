...
export const TOPPINGS: Topping[] = [
  ...
  ...["Cebolla", "Salsa Rudy", "Sin toppings"].map((name, index) => ({
    id: `t102_${index}`,
    menuItemId: "102",
    name,
    price: 0,
  ...
  ...[
    ...
    "Pepino",
    "Cebolla",
    "Salsa de tomate con curry",
    "Yogurt",
    "Salsa de sesamo thina",
    "Papas pay",
  ].map((name, index) => ({
    id: `t201_${index}`,
    menuItemId: "201",
  ...
  ...["Arroz de sushi", "Mix de verdes", "Quinoa"].map((name, index) => ({
    id: `t401b_${index}`,
    menuItemId: "401",
    name,
    price: 0,
  ...
  ...["Cebolla crispy", "Maíz crispy", "Sésamo"].map((name, index) => ({
    id: `t401c_${index}`,
    menuItemId: "401",
    name,
    price: 0,
...
export const EXTRAS: Extra[] = [
  ...
  ...["201", "202", "203"].map((menuItemId, index) => ({
    id: `e${menuItemId}_0`,
    menuItemId,
    name: "Papas",
    price: 0,
